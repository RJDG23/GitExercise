		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JS Code Assist",
									"targetURL": "#sapipstrainingjscodeassisttest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingjscodeassisttest-display": {
								"semanticObject": "sapipstrainingjscodeassisttest",
								"action": "display",
								"description": "JS Code Assist",
								"title": "JS Code Assist",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.jscodeassist.test",
									"url": sap.ui.require.toUrl("sapips/training/jscodeassist/test")
								}
							}
						}
					}
