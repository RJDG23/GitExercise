		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercise1gabertan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise1gabertan-display": {
								"semanticObject": "zbtpday5exercise1gabertan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise1gabertan",
									"url": sap.ui.require.toUrl("zbtp/day5exercise1gabertan")
								}
							}
						}
					}
