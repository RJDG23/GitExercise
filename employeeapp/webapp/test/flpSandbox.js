		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapipstrainingemployeeapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingemployeeapp-display": {
								"semanticObject": "sapipstrainingemployeeapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.employeeapp",
									"url": sap.ui.require.toUrl("sapips/training/employeeapp")
								}
							}
						}
					}
