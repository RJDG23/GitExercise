		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mock Service Activity",
									"targetURL": "#sapipstrainingmockservice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingmockservice-display": {
								"semanticObject": "sapipstrainingmockservice",
								"action": "display",
								"description": "Mock Service Activity",
								"title": "Mock Service Activity",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.mockservice",
									"url": sap.ui.require.toUrl("sapips/training/mockservice")
								}
							}
						}
					}
