		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mock Server",
									"targetURL": "#sapipstrainingmockservertest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingmockservertest-display": {
								"semanticObject": "sapipstrainingmockservertest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.mockserver.test",
									"url": sap.ui.require.toUrl("sapips/training/mockserver/test")
								}
							}
						}
					}
